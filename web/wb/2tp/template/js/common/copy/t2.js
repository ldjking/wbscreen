...
function initBtnDisabled() {
	var btnDisabled=[{"id":"btn_add"},{"id":"btn_edit"},{"id":"btn_search"},{"id":"btn_refresh"}];
...
function component() {
	...
	else	$('#middle').css("height",pageHeight-topHeight-downHeight-paddingHeight);	$('#tab').tabs({
		onSelect:tab_select,
		fit:true
	});
...
function useEditMode(){
	...
	if(panelType=="child")	$('#tab').tabs("select",2);
